...
/*		name			refresh	xres	yres	pixclock	h_bp	h_fp	v_bp	v_fp	h_pw	v_pw			polariry			PorI	flag		vic		2ndvic		pixelrepeat	interface */
	...
	/* { {	"1024x600p@60Hz",	60,	1024,	600,	52000000,	160,	160,	12,	123,	10,	10,	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,	0,	0	},	108,	HDMI_1024X600P_60HZ,	1,	OUT_P888},*/
      /* { {	"1024x600p@60Hz",	60,	1024,	600,	43000000,	50,	15,	40,	10,	5,	4,	FB_SYNC_HOR_HIGH_ACT | FB_SYNC_VERT_HIGH_ACT,	0,	0	},	108,	HDMI_1024X600P_60HZ,	1,	OUT_P888},*/
